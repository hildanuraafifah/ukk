            ...
            <tr>
                ...
                <td class="text-center">
                    <?php if (strtolower($b->status_barang) != 'terjual') : ?>
                        <center>
                            <?= anchor('admin/databaranglelang/edit/' . $b->id_barang, '<div class="btn btn-primary"><i class="fas fa-pen"></i></div>') ?>
                            <a onclick="return confirm('Apakah Anda Yakin Akan Menghapus Barang Ini?')"
                            class="btn btn-danger" href="<?= base_url('admin/databaranglelang/hapus/' . 
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ecampleModalLabel">Halaman Tambah Barangg</h5>
