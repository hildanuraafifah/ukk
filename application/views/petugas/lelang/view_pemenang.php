<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <hr>
            <a href="<?= base_url() ?>petugas/datapemenang" class="btn btn-danger">Kembali</a> <br><br>
            <div class="row">
                <div class="col-md-4">
                <div class="card mb-3">
                ...
                <div class="card mb-3">
                    <div class="card-heading btn btn-warning btn-sm-3">
                        ...
                        <div class="card-body"> <br>
                            ...
                            <?php else : ?>
                                <p><strong>Nama</strong>: <?= $max_bid->nama_lengkap; ?> <a href="<?= base_url('petugas/datapemenang') ?>"><i class="fas fa-solid fa-trophy"></i></a>
                                </p>
